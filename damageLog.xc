	...
	"damageLog": {
		...
		"log": {
			...
			"dmg-kind": {
				...
				"recovery": "{{l10n:forsaken}}<tab><font face='xvm'>&#x100;</font>",
				"death_zone": "DZ",
				"gas_attack": "GA",
				...
				"minefield": "{{hit-effects}}{{critical-hit}}{{splash-hit}}<tab><font face='xvm'>&#x117;</font>"
			},
			"c:dmg-kind": {
				"shot": "{{c:hit-effects}}",
				"fire": "#FF6655",
